...
const WaysToHelp = () => {
  ...
  <section className="py-20 bg-gradient-to-r from-green-600 to-Teal-600 text-white fade-in-up">
  ...
  <section className="py-20 fade-in-up delay-1">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {option.amounts.map((amount, amountIndex) => (
                        <button
                          key={amountIndex}
                          className="px-4 py-2 border border-gray-300 rounded-lg hover:border-Teal-500 hover:text-Teal-600 transition-colors duration-300"
                        >
                          {amount}
                        </button>
                      ))}
            ...
            {partnershipTypes.map((partnership, index) => (
              <div key={index} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                  <div className="card">
                    <div className="flex items-center mb-6">
                      <Handshake className="h-8 w-8 text-Teal-600 mr-4" />
      ...
      {/* Call to Action */}
      <section className="py-20 bg-custom-Teal text-white">
