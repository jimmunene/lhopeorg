                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <label className={`cursor-pointer p-4 border-2 rounded-lg transition-colors duration-300 ${
                      watchedFrequency === 'monthly' ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:border-gray-400'
                    }`}>
                      <input
                        {...register('frequency')}
                        type="radio"
                    ...
                    <label className={`cursor-pointer p-4 border-2 rounded-lg transition-colors duration-300 ${
                      watchedFrequency === 'onetime' ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:border-gray-400'
                    }`}>
                      <input
                        {...register('frequency')}
                        type="radio"
                    ...
                    <div className="mt-4">
                      <div className="relative">
                        ...
                        <input
                          ...
                          step="0.01"
                          placeholder="0.00"
                          className={`w-full pl-8 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
