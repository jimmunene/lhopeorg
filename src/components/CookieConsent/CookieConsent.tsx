...
const CookieConsent = () => {
  ...
  return (
    <>
      {/* Cookie Banner */}
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t-2 border-Teal-600 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div className="flex items-start space-x-4 flex-1">
              <Cookie className="h-8 w-8 text-Teal-600 flex-shrink-0 mt-1" />
              <div className="flex-1">
                ...
                <button
                  ...
                  className="inline-flex items-center text-Teal-600 hover:text-Teal-800 text-sm font-medium mt-2"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
              ...
              <button
                onClick={() => setShowPreferences(true)}
                className="px-4 py-2 text-Teal-600 hover:text-Teal-800 border border-Teal-600 rounded-lg hover:bg-Teal-50 transition-colors duration-300 text-sm font-medium flex items-center justify-center"
              >
              ...
              <button
                ...
                className="px-6 py-2 bg-Teal-600 hover:bg-Teal-700 text-white rounded-lg transition-colors duration-300 text-sm font-medium flex items-center justify-center"
              >
