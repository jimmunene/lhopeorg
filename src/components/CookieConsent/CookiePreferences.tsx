...
const CookiePreferences: React.FC<CookiePreferencesProps> = ({
  ...
  const cookieCategories = [
    ...
    },
    {
      ...
      icon: <Cog className="h-6 w-6 text-cyan-600" />,
        ...
        <div className="inline-block w-full max-w-4xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
                      ...
                      {category.required ? (
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          <div className={`w-11 h-6 rounded-full transition-colors duration-300 ${
                            settings[category.id] ? 'bg-cyan-600' : 'bg-gray-300'
                          }`}>
            ...
            <div className="mt-8 p-4 bg-cyan-50 border border-cyan-200 rounded-lg">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  <h4 className="font-medium text-cyan-800 mb-1">Your Privacy Matters</h4>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center p-6 border-t border-gray-200 bg-gray-50">
            ...
            <div className="flex space-x-3">
              ...
              <button
                onClick={onAccept}
                className="px-6 py-2 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg transition-colors duration-300 flex items-center"
              >
